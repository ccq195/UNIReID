...
class Evaluator():
    ...
    def eval(self, model, i2t_metric=False):
        ...
        t2i_cmc1, t2i_mAP1, t2i_mINP1 = eval_func(-similarity_sketch_rgb.detach().cpu().numpy() , qids_sketch.numpy(), gids.numpy(), qimage_ids_sketch.numpy(), gimage_ids.numpy(), set=0, max_rank=10)
        t2i_cmc2, t2i_mAP2, t2i_mINP2 = eval_func(-similarity_textsketch_rgb.detach().cpu().numpy() , qids.numpy(), gids.numpy(), qimage_ids.numpy(), gimage_ids.numpy(), set=0, max_rank=10)

        # t2i_cmc00, t2i_mAP00, t2i_mINP00 = eval_func(-similarity_text_rgb.detach().cpu().numpy() , qids.numpy(), gids.numpy(), qimage_ids.numpy(), gimage_ids.numpy(), set=2, max_rank=10)
        # t2i_cmc11, t2i_mAP11, t2i_mINP11 = eval_func(-similarity_sketch_rgb.detach().cpu().numpy() , qids_sketch.numpy(), gids.numpy(), qimage_ids_sketch.numpy(), gimage_ids.numpy(), set=0, max_rank=10)
        # t2i_cmc22, t2i_mAP22, t2i_mINP22 = eval_func(-similarity_textsketch_rgb.detach().cpu().numpy() , qids.numpy(), gids.numpy(), qimage_ids.numpy(), gimage_ids.numpy(), set=0, max_rank=10)


        # t2i_cmc, t2i_mAP, _ = rank(similarity=similarity_text_rgb, q_pids=qids, g_pids=gids, max_rank=10, get_mAP=True)

        # t2i_cmc, t2i_mAP = t2i_cmc.cpu().numpy(), t2i_mAP.cpu().numpy()
        # t2i_cmc1, t2i_mAP1, t2i_mINP1 = t2i_cmc1.cpu().numpy(), t2i_mAP1.cpu().numpy(), t2i_mINP1.cpu().numpy()
        # t2i_cmc2, t2i_mAP2, t2i_mINP2 = t2i_cmc2.cpu().numpy(), t2i_mAP2.cpu().numpy(), t2i_mINP2.cpu().numpy()
        ...
        return t2i_cmc0[0], t2i_cmc1[0], t2i_cmc2[0]
